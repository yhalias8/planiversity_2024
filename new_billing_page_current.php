...
<head>
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=AWDljO0aE2niUp1U2atYIXp--9DW_M-9OkFMFemTC8PxWPrTBHd4XiKMTFScOMD_C6xAJxjBkN21tOnN&vault=true&intent=subscription&disable-funding=credit,card" data-sdk-integration-source="button-factory"></script>
...
<body>
                                                                ...
                                                                <div class="billing_content_left_item">
                                                                    ...
                                                                    <div class="current_plan_item">
                                                                        ...
                                                                        <?php if ($user_payment_status == 0) { ?>
                                                                            <h6>FREE</h6>
                                                                        <?php } else { ?>
                                                                            <h6>Expires <?= $user_active_plan->date_expire; ?></h6>
                                                                        <?php } ?>
                                                                    </div>
                                                                            ...
                                                                            ?>
                                                                                    ...
                                                                                    <li>
                                                                                        <div class="plan_history_items">
                                                                                            <div class="row">
                                                                                                <div class="col-xl-8 col-8">
                                                                                                    <h4>Plan <?= $i ?> - <?= $plan_type ?></h4>
                                                                                                    <p><?= $data->date_paid; ?> - <?= $data->date_expire; ?></p>
                                                                                                </div>
                                                                    ...
                                                                    <div class="monthly_plan_radio">
                                                                        <ul class="list-unstyled plans_list">
                                                                            <li class="nav_active">
                                                                                ...
                                                                                <label class=" redio_button_desin"><span>Monthly Plan</span>
                                                                                    Only <p id="monthly-breakdown" class="price-breakdown"> $<?= $monthly_price; ?> </p> per plan
                                                                                    <input class="payment_type" type="radio" checked="checked" name="payment_type" value="monthly">
                                                                            ...
                                                                            <li>
                                                                                ...
                                                                                <label class=" redio_button_desin"><span>Annual Plan</span>
                                                                                    Only <p id="annual-breakdown" class="price-breakdown"> <?= $annual_price; ?></p> per plan
                                                                            ...
                                                                            <form action="" method="post">
                                                                                <div class="personal_information_form_item">
                                                                                    <div class="row">
                                                                                        <div class="col-xl-6 col-12 padding_left">
                                                                                            <div class="form_group">
                                                                                                ...
                                                                                                <input type="text" name="payment_fname" id="payment_fname" class="form-control" placeholder="Enter First Name" value="John">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-xl-6 col-12">
                                                                                            <div class="form_group">
                                                                                                <label>Last Name</label>
                                                                                                <input type="text" name="payment_lname" id="payment_lname" class="form-control" placeholder="Enter Last Name" value="Doe">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="row">
                                                                                        <div class="col-xl-12 padding_left form_group">
                                                                                            <label>Country</label>
                                                                                            <select name="payment_country" id="payment_country" class="form-control">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-xl-12 padding_left form_group">
                                                                                            <label>Address</label>
                                                                                            <input type="text" name="payment_address" id="payment_address" class="form-control" placeholder="Address">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="row">
                                                                                        <div class="col-xl-12 padding_left form_group">
                                                                                            <label>City</label>
                                                                                            <input type="text" name="payment_city" id="payment_city" class="form-control" placeholder="Enter your city">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="row">
                                                                                        <div class="col-xl-12 padding_left form_group">
                                                                                            <label>State</label>
                                                                                            <input type="text" name="payment_state" id="payment_state" class="form-control" placeholder="Residential">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="row">
                                                                                        <div class="col-xl-12 padding_left form_group">
                                                                                            <label>Zip Code</label>
                                                                                            <input type="tel" name="payment_zipcode" id="payment_zipcode" class="form-control" placeholder="Enter your Zip Code">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="inter_details_card">
                                                                                    <div class="row">
                                                                                        <div class="col-xl-12 padding_left form_group">
                                                                                            ...
                                                                                            <input type="number" name="payment_cardnumber" id="payment_cardnumber" class="form-control" placeholder="Enter your Card Number" value="4242424242424242" maxlength="19">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="row">
                                                                                        <div class="col-xl-4 col-12 padding_left">
                                                                                            <div class="form_group">
                                                                                                ...
                                                                                                <select class="form-control" name="payment_expmonth" id="payment_expmonth">
                                                                                        ...
                                                                                        <div class="col-xl-4 col-12 ">
                                                                                            <div class="form_group">
                                                                                                <label>&nbsp;</label>
                                                                                                <select class="form-control" name="payment_expyear" id="payment_expyear">
                                                                                        ...
                                                                                        <div class="col-xl-4 col-12">
                                                                                            <div class="form_group">
                                                                                                <label class="billing-label">CVC <span class="what_is_this" title="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.">What's This</span></label>
                                                                                                <input type="number" name="payment_cvc" id="payment_cvc" class="form-control" placeholder="Enter CVC" value="222" maxlength="4">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                                    ...
                                                                                                    <form id="coupon_form">
                                                                                                        <div class="row">
                                                                                                            <div class="col-xl-8 col-lg-8 col-7 form_group">
                                                                                                                <input type="text" class="form-control" name="coupon_code" id="coupon_code" placeholder="Coupon code" value="20OFF">
    ...
    <script>
        ...
        let dynamic_plan_id = "<?= $plan_id ?>";

        console.log('dynamic_plan_id', dynamic_plan_id);
        ...
        paypal.Buttons({
            ...
            onApprove: function(data, actions) {
                ...
                dynamic_plan_id = "<?= $plan_id ?>";
                console.log('dynamic_plan_id', dynamic_plan_id);

                swal({
                    title: "Subscription has been made successfully",
                    type: "success",
                    timer: 2500,
                    ...
                    window.open(SITE + "payment_confirmation?id=" + data.subscriptionID + "&type=subscription", '_blank');
                });
                $('#coupon-reset').click();
            },
        ...
        $('.payment_type').change(function() {
            ...
            if (value == "monthly") {
                ...
                $('#popupmess').html('I authorize Planiversity, LLC to bill this account annualy. I also understand that any requests for changes to billing must be submitted to Planiversity customer service.');
        ...
        function couponCalculation(percent) {
            var monthly_price = <?= $monthly_price; ?>;
            var annual_price = <?= $annual_price; ?>;
            ...
            if ((code == '') || (code == undefined)) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        couponCalculation(response.data.percent);
                        toastr.success("Coupon code applied ");
                        dynamic_plan_id = response.data.plan
                        console.log('dynamic_plan_id', dynamic_plan_id);
