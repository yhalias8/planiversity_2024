...
<script>
    ...
    var category_list = $('#category_list').DataTable({
        ...
        "columns": [{
            ...
            },
            {
                ...
                "render": function(data, type, row) {
                    ...
                    return "<img class='img-responsive table-image' src='{{ asset('storage/uploads/images/category') }}/" + data + "' />"
                }
        ...
        "columnDefs": [{
            "targets": -1,
            "data": null,
            "defaultContent": " <td><div align='center'><a id='edit' href='#update_modal' class='btn btn-mini btn-info view_action' role='button' data-toggle='modal' title='Edit Category'><i class='fa fa-eye'></i> </a>  <button id='delete' class='btn btn-mini btn-danger delete_action' title='Delete Category'><i class='fa fa-trash'></i> </a></div></td>"
        }],
