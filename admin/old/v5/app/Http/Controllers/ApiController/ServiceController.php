...
class ServiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $query = MarketplaceService::select('id', 'service_uuid', 'service_title', 'category_id', 'service_image', 'author_name', 'author_image', 'regular_price', 'sale_price', 'member_price', 'service_description', 'author_description', 'status')->where('status', 'active')->orderBy('id', 'asc')
