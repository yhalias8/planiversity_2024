                    ...
                    <div class="col-lg-4">
                        <div class="card-box">
                            ...
                            <div class="row">
                                ...
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="current_image" id="current_image" readonly value="{{ $singleData->service_image }}">
                                <input type="hidden" name="current_file" id="current_file" readonly value="{{ $singleData->downloadable_file }}">
                                <input type="hidden" name="current_author_image" id="current_author_image" readonly value="{{ $singleData->author_image }}">
