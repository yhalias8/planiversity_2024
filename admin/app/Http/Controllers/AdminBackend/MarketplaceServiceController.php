...
class MarketplaceServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        if ($request->ajax()) {
            ...
            if (isset($request->popup_active)) {
                $popup_active = $request->popup_active;
            }            
            ...
            $service->author_email = $request->author_email;
            $service->author_mobile = $request->author_mobile; 
            $service->international_number = $request->international_number;
            ...
            $service->location_identifier = $request->location_identifier;
            $service->location = $request->location;
            $service->latitude = $request->latitude;
            $service->longitude = $request->longitude;
            $service->popup_active = $popup_active;
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->ajax()) {
            ...
            if ($request->hasfile('inputfile')) {
                ...
                $height = "200";
                //$input_file->storeAs($apath, $author_file, 'public');
                $this->imageUpload($input_file, $apath, $author_file, $width, $height);
            }
