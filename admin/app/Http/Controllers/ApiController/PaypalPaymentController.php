...
class PaypalPaymentController extends Controller
{
    ...
    public function instance_execute(Request $request)
    {
        ...
        if ($result->state == 'approved' && empty($result->failed_transactions)) {
            ...
            $payer_info = $decode_result->payer->payer_info;
            ...
            $order_payment->fname = $payer_info->first_name;
            $order_payment->lname = $payer_info->last_name;
            $order_payment->email = $payer_info->email;
            ...
            if ($saved) {
                ...
                event(new ServiceOrderPurchasedEvent($serviceData, $subject, $order->order_number, $payer_info->first_name . " " . $payer_info->last_name, $payer_info->email, ""));
                $subject = "Thank you for your recent order";
                event(new UserPurchasedEvent($serviceData, $subject, $order->order_number, $payer_info->first_name . " " . $payer_info->last_name, $payer_info->email));                
