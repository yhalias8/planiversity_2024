        ...
        <div id="navigation" class="active">
            <ul class="navigation-menu header-top-bar-style">
                ...
                <li class="{{ (request()->segment(1) == 'transactions') ? 'active-link active' : '' }}">
                    <a href="{{ url('transactions/billing') }}">Transactions</a>
                </li>
                ...
                <li class="dropdown {{ (request()->segment(1) == 'blog') ? 'active-link active' : '' }}" id="navbarDropdownMenuLink">
                    <a>Blog</a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li><a class="dropdown-item {{ (request()->segment(2) == 'authors') ? 'active' : '' }}" href="{{route('user.author.list')}}">Authors</a></li>
                        <li><a class="dropdown-item {{ (request()->segment(2) == 'categories') ? 'active' : '' }}" href="{{route('user.blog.category.list')}}">Categories</a></li>
                        <li><a class="dropdown-item {{ (request()->segment(2) == 'posts') ? 'active' : '' }}" href="{{route('user.blog.post.list')}}">Blog Posts</a></li>
                    </ul>
                </li>                
