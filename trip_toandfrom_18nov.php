...
<body class="custom_toandfrom">
    ...
    <div class="navbar-custom old-site-colors">
        <div class="container-fluid">
            <div id="navigation">
                <ul class="navigation-menu text-left plan-nav">
                    <!--<li class="box">-->
    ...
    <div data-backdrop="false" id="schedule-modal" class="modal fade bs-example-modal-lg modal-to-and-from" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;top: 134px">
        <form name="location_form" method="post" class="toandfrom pt-3 location_form_1">
                        ...
                        <fieldset>
                                ...
                                <div class="row pt-2">
                                    ...
                                    <div class="col-md-12 col-lg-3">
                                        <div class="form-group frm-grp">
                                            <label class="mr-b-10">Arrival Date</label>
                                            <div class="date_picker_item">
                                                <input type="text" class="dashboard-form-control datepicker input-lg" placeholder="Arrival Date" name="location_dater_arr" value="" autocomplete="off" id="location_datel_arr" required="">
                                                <i class="fa fa-calendar" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-3">
                                        <div class="form-group frm-grp">
                                            <label class="mr-b-10">Arrival Time (HH:MM)</label>
                                            <input type="time" class="dashboard-form-control input-lg" placeholder="Arrival Time" name="location_dater_arrtime" value="<?php if ($trip) echo $trip->trip_location_dater_arrtime; ?>" autocomplete="off" id="location_datel_arrtime" required="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row" id="waypts_div" style="display:none;">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-6 col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="date_picker_item">
                                                                        <input type="text" name="" class="form-control datepicker" id="rental_date_pick" placeholder="Arrival Date">
                                                                        <i class="fa fa-calendar" aria-hidden="true"></i>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-6 col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="date_picker_item">
                                                                        <input type="text" name="" class="form-control datepicker" id="rental_date_pick" placeholder="Date of Departure">
                                                                        <i class="fa fa-calendar" aria-hidden="true"></i>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6 col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="date_picker_item">
                                                                            <input type="text" name="" class="form-control" placeholder="<?php echo $label; ?> Number">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-6 col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="" class="form-control" placeholder="Seat Number">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-12">
                                                                    <label for="add_hotel_detail">
                                                                        <input type="checkbox" id="add_hotel_detail" />
                                                                        Add Hotel Details
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div id="add_hotel_detail_value" style="display: none">
                                                                <div class="row">
                                                                    <div class="col-xl-12">
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="" rows="4" class="form-control" placeholder="Rental Agency Address"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-12">
                                                                    <label for="add_rental_deta_check">
                                                                        <input type="checkbox" id="add_rental_deta_check" />
                                                                        Add Rental Car Details
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div id="add_rental_deta_check_value" style="display: none">
                                                                <div class="row">
                                                                    <div class="col-xl-12">
                                                                        <div class="form-group">
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="add_stop_item_add">
                                        <a href="" class="add_stop_btn">Add Stop</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    ...
                                    <textarea rows="4" class="dashboard-form-control input-lg" placeholder="Enter Hotel Address" name="hotel_address" id="hotel_address" value='<?php if ($trip) echo $trip->trip_rental_agency_address; ?>'>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    ...
                                    <textarea class="dashboard-form-control input-lg" rows="4" placeholder="Rental Agency Address" name="rental_agency_address" id="rental_agency_address" value='<?php if ($trip) echo $trip->trip_rental_agency_address; ?>'></textarea>
                                </div>
                            </div>
    ...
    <script>
        $(function() {
            $("#add_rental_deta_check").click(function() {
                if ($(this).is(":checked")) {
                    $("#add_rental_deta_check_value").show();
                } else {
                    $("#add_rental_deta_check_value").hide();
                }
            });
        });
    </script>
    <script>
        $(function() {
            $("#add_hotel_detail").click(function() {
                if ($(this).is(":checked")) {
                    $("#add_hotel_detail_value").show();
                } else {
                    $("#add_hotel_detail_value").hide();
                }
            });
        });
    </script>
