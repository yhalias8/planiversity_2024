        ...
        <div class="container-fluid">
            ...
            <div class="menu-extras topbar-custom">
                <ul class="list-inline float-right mb-0">
                    <li class="menu-item list-inline-item  new-backend-header-style mobile_button" style="margin:27px 0;">
                        <a class="navbar-toggle nav-link">
                    ...
                    <li class="list-inline-item dropdown more-nav-list new-backend-header-style mobile_hide">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg" aria-labelledby="Preview">
                            ...
                            <!--<a href="<?php /*echo SITE; */ ?>faq" class="dropdown-item drop-menu-item">
                                Make a Payment
                            </a>-->
