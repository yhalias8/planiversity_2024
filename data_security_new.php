...
<div class="faqs-main-wrapper spacer">
  <div class="container">
    <div class="col-md-12 section-header">
      <h2 class="lhight blue-color">Data Security</h2>
    </div>
    <div class="row">
      <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
        <div class="faqs-wrapper">
          <div>
            <h5 class="mt-0 text-center">Information security protection is a standard.</h5>
            <p class="text-center">We know, data security is hugely important to customers of online services. We at Planiversity have taken the necessary steps to ensure that not only are we doing our part to protect your data, but also that those we partner and do business with are well-established and credible as well. Here are a few areas where Planiversity has taken steps to proactively protect your information:</p>
          </div>
          <div class="media row">
            <div class="col-md-12 col-lg-2 col-sm-12 col-xs-12">
              <img class="data-security-icon" src="images/server-security.png" alt="server security">
            </div>
            <div class="col-md-12 col-lg-10 col-sm-12 col-xs-12">
              <h5 class="mt-0">Server Security</h5>
          ...
          <div class="media row">
            <div class="col-md-12 col-lg-2 col-sm-12 col-xs-12">
              <img class="data-security-icon" src="images/pci-compliance.png" alt="pci compliance">
            </div>
            <div class="col-md-12 col-lg-10 col-sm-12 col-xs-12">
              <h5 class="mt-0">PCI Compliance</h5>
          ...
          <div class="media row">
            <div class="col-md-12 col-lg-2 col-sm-12 col-xs-12">
              <img class="data-security-icon" src="images/password-protection.png" alt="password protection">
            </div>
            <div class="col-md-12 col-lg-10 col-sm-12 col-xs-12">
              <h5 class="mt-0">PC Protection and Password Change Policy</h5>
          ...
          <div class="media row">
            <div class="col-md-12 col-lg-2 col-sm-12 col-xs-12">
              <img class="data-security-icon" src="images/payment-processing.png" alt="payment processing">
            </div>
            <div class="col-md-12 col-lg-10 col-sm-12 col-xs-12">
              <h5 class="mt-0">Payment Processing</h5>
          ...
          <div class="media row">
            <div class="col-md-12 col-lg-2 col-sm-12 col-xs-12">
              <img class="data-security-icon" src="images/ssl-certification.png" alt="ssl certification">
            </div>
            <div class="col-md-12 col-lg-10 col-sm-12 col-xs-12">
              <h5 class="mt-0">SSL Certificates</h5>
              <p>Our certificates are purchased through InMotion, the same company hosting Planiversity's server. These certificates are not only a critical step to authenticating the security of our website, but they also serve to protect and encrypt user information.</p>
            </div>
          </div>

          <p class="bottom-quote"><i class="fa fa-quote-left"></i>The breach or theft of cardholder data affects the entire payment card ecosystem. Customers suddenly lose trust in merchants or financial institutions; their credit can be negatively affected -- there is enormous personal fallout. Merchants and financial institutions lose credibility (and in turn, business), they are also subject to numerous financial liabilities.

            <br> <strong>~ PCI Security Standard Council</strong>
          </p>
        </div>
      </div>
    </div>
