...
<body class="custom_toandfrom">
            ...
            <div class="modal-content modal-rounded-sm modal-content-white">
                <div class="modal-header pt-2 itinerary-header">
                    ...
                    <div class="heading_section">
                        <p>PLANVERSITY</p>
                        <h4 class="modal-title" id="myLargeModalLabel">Build Your Appointment Itinerary</h4>
                    </div>
                </div>
                ...
                <div class="modal-body connect-bg-ground" id="schedule-modal-body">
                    ...
                    <fieldset id="build_place">
                        <form id="myForm" action="#" method="POST" class="main_form">
                            <input type="hidden" name="itinerary_type" value="appt">

                            <div class="itinerary_tab">
                                <div class="itinerary_section">
                                    <h3>What is the location of the Appointment?</h3>
                                    <p>Enter your appointment address point</p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-lg-6 mx-auto">
                                                            <div class="form-group frm-grp">
                                                                <label class="mr-b-10">Appointment location</label>
                            ...
                            <div class="itinerary_tab">
                                ...
                                <div class="itinerary_section">
                                    ...
                                    <h3>How long will this appointment take?</h3>
                                    <p>Add details for your schedule.</p>
                                    <div class="itinerary_content">
                                    ...
                                    <div class="single_event_section pt-5" style="display:none;">
                                        <h3>What is the date of your appointment?</h3>
                                        <p>Enter your date</p>
                            ...
                            <div class="itinerary_tab">
                                ...
                                <div class="itinerary_section">
                                    ...
                                    <h3>What time is the Appointment?</h3>
                                    <p>Add details for your appointment schedule.</p>
                                    <div class="itinerary_content">
                                                ...
                                                <div class="row justify-content-center text-left">
                                                    <div class="col-md-12 col-lg-4">
                                                        <div class="form-group frm-grp trip-grp">
                                                            <label class="mr-b-10">Starting time (HH:MM)</label>
                                                    ...
                                                    <div class="col-md-12 col-lg-4">
                                                        <div class="form-group frm-grp trip-grp">
                                                            <label class="mr-b-10">Ending time (HH:MM)</label>
                            ...
                            <div class="itinerary_tab">
                                ...
                                <div class="itinerary_section">
                                    ...
                                    <h3>Who is the appointment with ?</h3>
                                    ...
                                    <div class="itinerary_content">
                                        ...
                                        <div class="row text-left">
                                            <div class="col-md-6 mx-auto">
                                                ...
                                                <div class="form-group frm-grp">
                                                    <input name="location_with_name" id="location_with_name" type="text" class="dashboard-form-control form-control input-lg clearable" placeholder="Name">
                                                </div>
                                        ...
                                        <div class="itinerary_content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group frm-grp">
                                                        <input name="location_where_to" id="location_where_to" type="text" class="dashboard-form-control form-control input-lg clearable" placeholder="Where to">
                            ...
                            <div class="itinerary_tab">
                                ...
                                <div class="itinerary_section">
                                    ...
                                    <h3>Do you need to add special instructions or a document with special instructions?</h3>
                                        ...
                                        <div class="itinerary_content">
                                            ...
                                            <div class="row">
                                                <div class="col-8 mx-auto">
                                                    <label class="mr-b-10"> Notes <span class="label_info">(optional)</span></label>

                                                    <div class="form-group frm-grp">
                                                        <textarea style="padding:15px;" autofocus="" name="location_note" id="location_note" maxlength="500" cols="" class="dashboard-form-textarea-control input-lg" rows="6" placeholder="Add Note" spellcheck="false"></textarea>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="mt-4">
                                                        ...
                                                        <div class="d-flex justify-content-between p-0 align-items-center w-35 gray-border-left">
                                                            <input type="file" class="file-document" id="location_document" name="location_document" accept="application/msword, application/vnd.ms-powerpoint,text/plain, application/pdf, image/*">

                                                            <label class="upload-button" for="location_document">
    ...
    <script>
        ...
        $('input[type="checkbox"][name=document_option]').on('change', function() {
