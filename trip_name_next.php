...
<head>
    ...
    <link href="<?php echo SITE; ?>assets/css/app-style.css?v=20908990" rel="stylesheet" type="text/css" />

    <link href="<?= SITE; ?>style/style.css?v=20908990" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div id="proceed-to-pdf-modal" data-backdrop="false" class="modal fade bs-example-modal-lg master_modal custom_prefix_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
        <form id="name_form" method="post" class="routemap" >
                                    ...
                                    <div class="d-flex flex-row flex-wrap pt-4 action-section">
                                        ...
                                        <div class="right-action">
                                            <div class="form-group mr-3">
                                                <button name="name_submit" id="name_submit" type="submit" style="color: #0d2972;" class="create-trip-btn" value="Proceed To PDF">Proceed To PDF</button>
                                            </div>
                                            <div class="mt-2">
    ...
    <script>
        ...
        $('#reload-btn').click(function() {
            ...
            console.log('preview_proceced-reload', preview_proceced);

            if (preview_proceced == 2) {
                name_title_hole = $('#name_title').val();
