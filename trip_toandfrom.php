...
<head>
    ...
    <link href="<?php echo SITE; ?>assets/css/multi-form.css?v=202022" rel="stylesheet" type="text/css" />
    <link href="<?php echo SITE; ?>assets/css/app-style.css?v=v202090" rel="stylesheet" type="text/css" />
    ...
    <script src="<?php echo SITE; ?>assets/js/multi-form.js?v=2023050421"></script>
    <script src="https://momentjs.com/downloads/moment.js"></script>
    <script src="<?= SITE; ?>js/global.js?v=20240612"></script>
    <style>
        .close-icon-portion:after {
...
<body class="custom_toandfrom">
                ...
                <div class="modal-body connect-bg-ground" id="schedule-modal-body">
                    <fieldset id="build_place">
                        <form id="myForm" action="#" method="POST" class="main_form">
                            ...
                            <div class="itinerary_tab">
                                <div class="itinerary_section">
                                    <h3>Do you want to add stay-over (i.e. hotel, apartment) details?</h3>
                                    <p>Add stay-over details for your trip.</p>
                                    <div class="itinerary_content">
                                        <div class="row">
                                            <div class="col-lg-12 col-xl-12">
                                                <div class="options">
                                    ...
                                    <div class="hotel_entry_section mt-5" style="display:none;">
                                        <h3>Please add your stay-over (i.e. hotel, apartment) details</h3>
                                        <p>Enter your stay-over details</p>
                                        <div class="itinerary_content">
                                                ...
                                                <div class="col-lg-12 col-xl-12">
                                                    <div class="row">
                                                        <div class="col-md-12 col-lg-4">
                                                            <div class="form-group frm-grp">
                                                                <label class="mr-b-10">Stay-over Name</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 col-lg-12">
                                                            <div class="form-group frm-grp">
                                                                <label class="mr-b-10">Stay-over Address</label>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div id="driving" style="display:none;">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group frm-grp">
                                                                                <input name="location_from_drivingportion" id="location_from_drivingportion" type="text" class="dashboard-form-control input-lg form-control clearable" placeholder="Driving Start">
                                                                                <button class="close-icon from-part close-icon-portion" type="reset" ></button>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group frm-grp">
                                                                                <input name="location_to_drivingportion" id="location_to_drivingportion" type="text" class="dashboard-form-control input-lg form-control clearable" placeholder="Driving Destination">
                                                                                <button class="close-icon from-part close-icon-portion" type="reset" ></button>
                                                                            </div>
                                                                ...
                                                                <div class="form-group text-center">
                                                                    ...
                                                                    <div id="flight" style="display:none;">
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group frm-grp">
                                                                                    <input name="location_from_flightportion" id="location_from_flightportion" type="text" class="dashboard-form-control input-lg form-control clearable" placeholder="Takeoff Location">
                                                                                    <button class="close-icon from-part close-icon-portion" type="reset" ></button>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group frm-grp">
                                                                                    <input name="location_to_flightportion" id="location_to_flightportion" type="text" class="dashboard-form-control input-lg form-control clearable" placeholder="Destination Location">
                                                                                    <button class="close-icon from-part close-icon-portion" type="reset" ></button>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="form-group text-center">
                                                                    ...
                                                                    <div id="train" style="display:none;">
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group frm-grp">
                                                                                    <input name="location_from_trainportion" id="location_from_trainportion" type="text" class="dashboard-form-control input-lg form-control clearable" placeholder="Takeoff Location">
                                                                                    <button class="close-icon from-part close-icon-portion" type="reset" ></button>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group frm-grp">
                                                                                    <input name="location_to_trainportion" id="location_to_trainportion" type="text" class="dashboard-form-control input-lg form-control clearable" placeholder="Destination Location">
                                                                                    <button class="close-icon from-part close-icon-portion" type="reset" ></button>
                                                                                </div>
                                                                            </div>
    ...
    <script>
        ...
        $("#location_dater, #location_dater_deptime").on("change", function() {
            tools.populateArrivalTimeOnReturn();
        });

        $("#location_datel_deptime, #location_datel").on("change", function() {
            tools.populateArrivalTimeOnTrip();
        });
        var tools = {
            distanceSeconds: -1,
            setDistanceInSeconds: function(sec) {
                this.distanceSeconds = sec;
            },
            calculateArrivalTime: function(depTime, depDate, distanceSeconds) {
                if (depTime == '' || depDate == '') {
                    return null;
                }

                var depDateTimeString = depDate + ' ' + depTime;
                var depDateTime = new Date(depDateTimeString);
                if (isNaN(depDateTime.getTime())) {
                    console.error("Invalid date or time format");
                    return null;
                }

                var arrivalDateTime = new Date(depDateTime.getTime() + distanceSeconds * 1000);

                var arrivalDate = arrivalDateTime.toLocaleDateString('en-US', {
                    month: '2-digit',
                    day: '2-digit',
                    year: 'numeric'
                });
                var arrivalTime = arrivalDateTime.toLocaleTimeString('en-US', {
                    hour: '2-digit',
                    minute: '2-digit',
                    hour12: false
                });
            ...
            populateArrivalTimeOnTrip: function () {
                var depTime = $("#location_datel_deptime").val();
                var depDate = $("#location_datel").val();
                if (depTime == '' || depDate == '' || this.distanceSeconds == -1) {
                    return;
                }

                var result = this.calculateArrivalTime(depTime, depDate, this.distanceSeconds);
                if (result) {
                    $("#location_datel_arrtime").val(result.arrivalTime);
                    $("#location_datel_arr").val(result.arrivalDate);
                }
            },
            populateArrivalTimeOnReturn: function () {
                console.log("populateReturn");
                var depTime = $("#location_dater_deptime").val();
                var depDate = $("#location_dater").val();
                if (depTime == '' || depDate == '' || this.distanceSeconds == -1) {
                    return;
                }
                ...
                var result = this.calculateArrivalTime(depTime, depDate, this.distanceSeconds);
                if (result) {
                    $("#location_dater_arrtime").val(result.arrivalTime);
                    $("#location_dater_arr").val(result.arrivalDate);
                }
            }
        };
    ...
    <script>
        ...
        function AutocompleteDirectionsHandler(map) {
            ...
            directionsRenderer.addListener("directions_changed", () => {
                ...
                if (result.routes[0].legs.length > 0) {
                    ...
                    tools.setDistanceInSeconds(calcTotalDurationSec(result));
                    let distance_calculation = calcTotalDistanceText(result);
                    let duration_calculation = calcTotalDurationText(result);

                    //$("#departure_from_location").html($("#location_from").val());
                    //$("#arrival_at_location").html($("#location_to").val());
        ...
        function hotelPlaceChangedListenerPortion(autocomplete, ptype) {
            ...
            autocomplete.addListener('place_changed', function() {
                ...
                if (place) {
                    ...
                    if (document.getElementById('location_to_latlng_drivingportion') != null) {
                        document.getElementById('location_to_latlng_drivingportion').value = place.geometry.location;
                        document.getElementById('location_from_latlng_drivingportion').value = place.geometry.location;
                        $("#location_to_drivingportion").val(place.name + ", " + place.formatted_address);
                    } else if (document.getElementById('location_to_latlng_trainportion') != null) {
                        document.getElementById('location_to_latlng_trainportion').value = place.geometry.location;
                        document.getElementById('location_from_latlng_trainportion').value = place.geometry.location;
                        $("#location_to_trainportion").val(place.name + ", " + place.formatted_address);
                    }
            ...
            if (transportWay === 'vehicle') {
                ...
                this.directionsService.route({
                    ...
                    if (status === 'OK') {
                        ...
                        tools.setDistanceInSeconds(calcTotalDurationSec(response));
                        $('.trip_info').html(path_calculation("<?= $distance_mode ?>", distance_calculation, duration_calculation));                        
        ...
        function addLocationToStop(index,type) {
            ...
            function calculateDistances() {
                let startPoint = document.getElementById('location_from').value;
                let inputElements = document.querySelectorAll('input[name="multi_location_waypoint[]"]');
                ...
                for (let i = 0; i < points.length - 1; i++) {
                    if (points[i] && points[i + 1]) {
                        calculateDistance(points[i], points[i + 1], i + 1);
                    }
                }
            }
            ...
            function getTravelModeFromUrl() {
                // Pobranie bieżącego URL-a z przeglądarki
                let url = window.location.href;

                // Rozdzielenie URL-a na segmenty
                let segments = url.split('/');
                // Ostatni segment URL-a
                let lastSegment = segments[segments.length - 1];

                // Mapowanie ostatniego segmentu na tryb podróży
                switch (lastSegment) {
                    case 'plane':
                        return 'FLYING';
                    case 'train':
                    ...
                    case 'vehicle':
                        return 'DRIVING';
                    default:
                        return 'UNKNOWN'; // Możesz zwrócić wartość domyślną lub rzucić błąd
                }
            }

            function calculateDistance(origin, destination, segment) {
                let travelMode = getTravelModeFromUrl();
                    ...
                    service.getDistanceMatrix({
                        ...
                        if (status == 'OK') {
                            ...
                            if (results[0].status == 'OK') {
                                let duration = formatDuration(results[0].duration.value);
                                let distanceMiles = results[0].distance.value * 0.000621371;

                                let message = '';
                                if (getTravelModeFromUrl() == 'DRIVING') {
                                    message = `<b>Driving distance</b> : ${distanceMiles.toFixed(2)} mi<br><b>Duration</b> : ${duration}.`;
                                } else {
                                    message = `<b>Driving distance</b> : ${distanceMiles.toFixed(2)} mi<br><b>Duration</b> : ${duration}.`;
                                }
                                $("#multi_location_waypoint_distance" + (segment - 1)).html(message);
                            } else {
                                console.log('Error: ' + results[0].status);
                            }
                        } else {
                            console.log('Distance Matrix Service was not successful for the following reason: ' + status);
                        }
                    });
                }
            }
                ...
                var html = `<div class="set set${add_more_stop_count}">
                                ...
                                <div class="content content${add_more_stop_count}">
                                    <div class="accordion_container_item_first">
                                        ...
                                        <div class="row"><div class="col-xl-12"><div id="multi_location_waypoint_distance${add_more_stop_count}"></div></div></div>
                                    </div>`;
                <?php if ($transport != 'vehicle') { ?>
        ...
        function setDrivingAndTrain() {
            setTimeout(function() {
                ...
                var hotelLocation = document.getElementById("hotel_address").value;
    ...
    var customPickerOptions = {
        ...
        $('.end-date').datepicker().on("changeDate", function() {
            ...
            var formattedStartDateHotel = moment(endDate).format("YYYY-MM-DD");
            $('#hotel_date_checkin').val(formattedStartDateHotel);
        });
        ...
        $('#location_datel_deptime').on('change', function() {
            var startDate = $('#location_datel').datepicker('getDate');
            var start_date = moment(startDate).format("YYYY-MM-DD");
            var deptime = $(this).val();
            if ((duration_action) && (startDate)) {
                if (duration_day == 0) {
                    var formattedStartDate = moment(startDate).format("MM/DD/YYYY");
                    var formattedStartDateHotel = moment(startDate).format("YYYY-MM-DD");
                    $('.end-date').val(formattedStartDate);
                    $('#hotel_date_checkin').val(formattedStartDateHotel);
                } else {
                    var startDateCal = moment(startDate);
                    if (duration_day === 1) {
                        var endDate = startDateCal.add(duration_day, 'day');
                    } else {
                        var endDate = startDateCal.add(duration_day, 'days');
                    }
                    var formattedEndDate = endDate.format('MM/DD/YYYY');
                    var formattedStartDateHotel = endDate.format('YYYY-MM-DD');
                    var start_arrival_date = endDate.format('YYYY-MM-DD');
                    $('.end-date').val(formattedEndDate);
                    $('#hotel_date_checkin').val(formattedStartDateHotel);
                    date_range_calculation(start_date, start_arrival_date, customClasses);
                }
                date_calculation.datepicker("update");
                if ((duration_action) && (deptime)) {
                    let momentTime = moment(deptime, 'HH:mm'); // Parse the time using Moment.js
                    if (duration_hour > 0) {
                        if (duration_hour === 1) {
                            momentTime.add(1, 'hour'); // Add 1 hour to the parsed time
                        } else {
                            momentTime.add(duration_hour, 'hours'); // Add duration_hour hours to the parsed time
                        }
                    }
                    if (duration_min > 0) {
                        if (duration_min === 1) {
                            momentTime.add(1, 'minute'); // Add 1 minute to the parsed time
                        } else {
                            momentTime.add(duration_min, 'minutes'); // Add duration_min minutes to the parsed time
                        }
                    }
                    console.log('momentTime', momentTime);
                    var formattedTime = momentTime.format('HH:mm');
                    $('#location_datel_arrtime').val(formattedTime);
                }
            }
        });        
    </script>
