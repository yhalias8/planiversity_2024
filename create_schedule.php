...
<head>
    ...
    <link href="<?= SITE; ?>assets_itinerary/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="<?= SITE; ?>assets_itinerary/css/icons.css" rel="stylesheet" type="text/css" />

    <link href="<?= SITE; ?>assets_itinerary/css/jquery.datetimepicker.css" rel="stylesheet" type="text/css">

    <link href="<?= SITE; ?>assets_itinerary/css/app-style.css" rel="stylesheet" type="text/css" />


    <script src="<?= SITE; ?>assets_itinerary/js/modernizr.min.js"></script>
...
<body>
    ...
    <header id="topnav">
        <div class="topbar-main">
            <div class="container-fluid">
                <div class="logo">
                    <a href="" class="logo">
                        <span class="logo-small"><img src="<?= SITE; ?>assets_itinerary/images/logo-icon.png" alt="logo icon"></span>
                        <span class="logo-large"><img src="<?= SITE; ?>assets_itinerary/images/logo-icon.png" alt="logo icon"><span>Planiversity</span></span>
                    </a>
                </div>
                    ...
                    <ul class="list-inline float-right mb-0">
                        ...
                        <li class="list-inline-item dropdown more-nav-list">
                            <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="" role="button" aria-haspopup="false" aria-expanded="false">
                                <img src="<?= SITE; ?>assets_itinerary/images/avatar-1.jpg" alt="user" class="rounded-circle">
                            </a>
                    ...
                    <ul class="navigation-menu text-center">
                        <li class="box">
                            <a href="" class="left-nav-button top-progress active-step scale" data-toggle="modal" data-target="#schedule-modal2" data-backdrop="false">
                                <img src="<?= SITE; ?>assets_itinerary/images/step_calendar.png" alt="Schedule">
                                <p>Schedule</p>
                            </a>
                        </li>
                        <li class="step-arrow">
                            <a href="" class="left-nav-button top-progress" data-toggle="modal" data-target="#note-modal">
                                <img src="<?= SITE; ?>assets_itinerary/images/step_notes.png" alt="Notes">
                                <p>Notes</p>
                            </a>
                        </li>
                        <li class="step-arrow">
                            <a href="" class="left-nav-button top-progress">
                                <img src="<?= SITE; ?>assets_itinerary/images/step_filters.png" alt="Filters">
                                <p>Filters</p>
                            </a>
                        </li>
                        <li class="step-arrow">
                            <a href="" class="left-nav-button top-progress">
                                <img src="<?= SITE; ?>assets_itinerary/images/step_documents.png" alt="Documents">
                                <p>Documents</p>
                            </a>
                        </li>
                        <li class="step-arrow">
                            <a href="" class="left-nav-button top-progress" data-toggle="modal" data-target="#connect-modal">
                                <img src="<?= SITE; ?>assets_itinerary/images/step_connect_sources.png" alt="Documents">
                                <p>Connect</p>
                            </a>
                        </li>
                        <li class="step-arrow">
                            <a href="" class="left-nav-button top-progress">
                                <img src="<?= SITE; ?>assets_itinerary/images/step_pdf.png" alt="Export">
                                <p>Export</p>
                            </a>
                        </li>
                    </ul>
    ...
    <div id="schedule-modal2" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-8">
                                <div class="form-group">
                                    <input type="text" class="dashboard-form-control input-lg" placeholder="Add New Event" required="">
                                </div>
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="cal-time-wrap">
                                                ...
                                                <div class="time-input">
                                                    <input type="time" class="form-control timer-input" tabindex="53" placeholder="1 : 30 AM">
                                                </div>
                                            </div>
                                        </div>
    ...
    <script src="<?= SITE; ?>assets_itinerary/js/jquery.min.js"></script>

    <!-- <script src="<?= SITE; ?>assets_itinerary/js/jquery-3.2.1.slim.min.js"></script> -->

    <!-- <script src="<?= SITE; ?>assets_itinerary/js/jquery.datetimepicker.full.min.js"></script> -->

    <script src="<?= SITE; ?>assets_itinerary/js/moment.min.js"></script>

    <script src="<?= SITE; ?>assets_itinerary/js/bootstrap-datepicker.js"></script>


    <script src="<?= SITE; ?>assets_itinerary/js/popper.min.js"></script>
    <script src="<?= SITE; ?>assets_itinerary/js/bootstrap.min.js"></script>
    <script src="<?= SITE; ?>assets_itinerary/js/jquery.slimscroll.js"></script>

    <script src="<?= SITE; ?>assets_itinerary/js/jquery.core.js"></script>
    <script src="<?= SITE; ?>assets_itinerary/js/jquery.app.js"></script>
