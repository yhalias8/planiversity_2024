<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $('#showhidepassword').click(function() {
      ...
      if (x.type === "password") {
        x.type = "text";
        document.getElementById("showhidepassword").src = "<?= SITE; ?>images/if_misc-_eye_vision_1276868.png";
      } else {
        x.type = "password";
        document.getElementById("showhidepassword").src = "<?= SITE; ?>images/if_misc-_eye_vision_1276868.png";
      }
...
<header class="main_head">
  <div class="cont_in">
    <h1><a href="<?= SITE . $welcomelink; ?>"><img src="<?= SITE; ?>images/logo.png" class="logo" alt="" />Planiversity</a></h1>
