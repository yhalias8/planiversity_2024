            ...
            <div class="cont_blue_in">
              ...
              <div class="cont_blue_l">
                <div class="style_form1">
                  ...
                  <div class="form_up"><label>Passport:</label>
                    <div id="fileuploader_passport">Upload</div>
                    <div id="fileload_passport"></div><br clear="all" />
                    <input name="documents_loadpassport" id="documents_loadpassport" type="button" class="button bt_grey bt_grey2" value="REVIEW PASSPORTS ATTACHMENTS">
                  </div>
                  <div class="form_up">
                    <label>Driver's License:</label>
                    <div id="fileuploader_driver">Upload</div>
                    <div id="fileload_driver"></div><br clear="all" />
                    <input name="documents_loaddriver" id="documents_loaddriver" type="button" class="button bt_grey bt_grey2" value="REVIEW DRIVER'S LICENSE ATTACHMENTS">
                  </div>
                  <div class="form_up">
                    <label>Hotel Itinerary:</label>
                    <div id="fileuploader_hotel">Upload</div>
                    <div id="fileload_hitinerary"></div><br clear="all" />
                    <input name="documents_loadhitinerary" id="documents_loadhitinerary" type="button" class="button bt_grey bt_grey2" value="REVIEW HOTEL ITINERARY ATTACHMENTS">
                  </div>
                  <div class="form_up">
                    <label>Travel Itinerary:</label>
                    <div id="fileuploader_flight">Upload</div>
                    <div id="fileload_fitinerary"></div><br clear="all" />
                    <input name="documents_loadfitinerary" id="documents_loadfitinerary" type="button" class="button bt_grey bt_grey2" value="REVIEW FLIGHT ITINERARY ATTACHMENTS">
                  </div>
                  <div class="form_up">
                    <label>Additional Docs:</label>
                    <div id="fileuploader_additional">Upload</div>
                    <div id="fileload_additional"></div><br clear="all" />
                    <input name="documents_additional" id="documents_additional" type="button" class="button bt_grey bt_grey2" value="REVIEW ADDITIONAL DOCUMENTS">
                  </div>
