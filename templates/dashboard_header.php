...
<header id="topnav">
        ...
        <div class="container-fluid">
            <div class="logo">
                <a href="<?= SITE; ?>" class="logo">
                    <span class="logo-small"><img src="<?= SITE; ?>assets/images/logo-icon1.png" width="40" alt="logo icon"></span>
    ...
    if ($userdata['account_type'] == 'Business' || $userdata['account_type'] == 'Admin') { ?>
        <div class="navbar-custom">
            <div class="container-fluid">
                <div id="navigation">
                    <ul class="navigation-menu text-center" id="menu">
                        <li>
                            <div class="header-titles">
                                <a href="<?= SITE ?>welcome" class="left-nav-button <?= $page_name == 'welcome' ? 'active-color' : ''; ?>">
                                    Home
                                </a>
                                <div class="header-bottom-style <?= $page_name == 'welcome' ? 'menu-active' : ''; ?>"></div>
                            </div>
                        </li>
                        <li>
                            <div class="header-titles">
                                <a href="<?= SITE ?>people" class="left-nav-button  <?= $page_name == 'people' ? 'active-color' : ''; ?>">
                                    People
                                </a>
                                <div class="header-bottom-style <?= $page_name == 'people' ? 'menu-active' : ''; ?>"></div>
                            </div>
                        </li>
                        <li>
                            <div class="header-titles">
                                <a href="<?= SITE ?>jobs" class="left-nav-button  <?= $page_name == 'jobs' ? 'active-color' : ''; ?>">
                                    Jobs
                                </a>
                                <div class="header-bottom-style <?= $page_name == 'jobs' ? 'menu-active' : ''; ?>"></div>
                            </div>
                        </li>
                        <li class="a-menu-element">
                            <div class="header-titles">
                                <a href="<?= SITE ?>events" class="left-nav-button  <?= $page_name == 'events' ? 'active-color' : ''; ?>">
                                    Events
                                </a>
                                <div class="header-bottom-style <?= $page_name == 'events' ? 'menu-active' : ''; ?>"></div>
                            </div>
                        </li>
                        <li class="a-menu-element">
                            <div class="header-titles">
                                <a href="<?= SITE ?>meetings" class="left-nav-button  <?= $page_name == 'meetings' ? 'active-color' : ''; ?>">
                                    Meetings
                                </a>
                                <div class="header-bottom-style <?= $page_name == 'meetings' ? 'menu-active' : ''; ?>"></div>
                            </div>
                        </li>
                    </ul>
                </div>
