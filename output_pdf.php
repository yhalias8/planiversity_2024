...
$logo_img = K_PATH_IMAGES . 'logo1.png';
    ...
    <table class="body">
			<tr>
				...
				<td width="90%" rowspan="2">
					<p style="color:#0D256E; font-size:25px; font-weight:bold;">Hotel Booking</p>
			   		<table width="100%">
			   			<tr class="content-1">
			   				<td width="70%"><p style="color:#67758D; font-size:14px"><b>Hotel Name:</b> <span>' . $trip->trip_hotel_name . '</span></p></td>
			   				<td width="30%"><p style="color:#F39F32; font-size:14px; text-align:right">Check-in:' . $trip->trip_hotel_date_checkin . '</p></td>
			   			</tr>
			   			<p style="width:100%; color:#fff; background-color:#fff; font-size:4px">e</p>
			   			<tr class="content-1">
			   				<td width="70%"><p style="color:#67758D; font-size:14px"><b>Hotel Address:</b> <span>' . $trip->trip_hotel_address . '</span></p></td>
			   				<td width="30%"><p style="color:#F39F32; font-size:14px; text-align:right">Check-out:' . $trip->trip_hotel_date_checkout . '</p></td>
			   			</tr>		   						   		
			   		</table>
				</td>
			</tr>
					...
					<p style="color:#0D256E; font-size:25px; font-weight:bold;">Rental Car Information</p>
			   		<table width="100%">
			   			<tr class="content-1">
			   				...
			   				<td width="30%"><p style="color:#F39F32; font-size:14px; text-align:right">Pick-up:' . $trip->trip_rental_date_pick . '</p></td>
			   			</tr>
			   			<p style="width:100%; color:#fff; background-color:#fff; font-size:4px">e</p>
			   			<tr class="content-1">
			   				<td width="70%"><p style="color:#67758D; font-size:14px"><b>Location:</b> <span>' . $trip->trip_rental_agency_address . '</span></p></td>
			   				<td width="30%"><p style="color:#F39F32; font-size:14px; text-align:right">Drop-off:' . $trip->trip_rental_date_drop . '</p></td>
			   			</tr>		   						   		
			   		</table>
				</td>
			</tr>
				...
				<table class="body">
					<tr>
						...
						<td width="90%" rowspan="2">
							   ...
							   <table width="100%">
								   <tr class="title" style = "vertical-align: bottom;">
									   <td width="50%"><span style="color:#0D256E; font-size:25px; font-weight:bold;">Drive Information</span></td>
									   <td width="50%" style ="text-align:right"><p style="width:100%; color:#fff; background-color:#fff; font-size:4px">e</p><p style="color:#F39F32; font-size:14px; text-align:right" >Date:' . $trip->trip_location_datel . '</p></td>
								   </tr>
					...
					<tr height:calc(100% - 0px)>
						<td style="text-align:center;height:calc(100% - 0px)">
							<img src="' . $dot_image1 . '" width="2px" height="100px">
						</td>
					</tr>
				</table>		
				';
            ...
            $departure_information .= '
				<table class="body">
					<tr>
						...
						<td width="90%" rowspan="2">
							<p style="color:#0D256E; font-size:25px; font-weight:bold;">Train Information</p>
							   <table width="100%">
								   <tr class="title">
									   <td width="50%"><p style="color:#3E4754; font-size:14px;">Train:' . $trip->trip_dep_flight_no . '/Seat ' . $trip->trip_dep_seat_no . '</p></td>
    ...
    for ($i = 0; $i < count($location_multi_waypoint); $i++) {
        $multi_waypoint .= '
				...
				<tr>
					...
					<td width="90%" rowspan="1">
						<span style="color:#0D256E; font-size:25px; font-weight:bold;">' . $text[$i] . ' Stop</span><br>
						<table width="100%">
							<tr class="title">
								<td width="70%" style="color:#67758D; font-size:14px"><b>Destination Address:</b> <span>' . $location_multi_waypoint[$i] . '</span></td>
								<td width="30%" style="color:#F39F32; font-size:14px; text-align:right">Date:' . $location_multi_waypoint_date[$i] . '</td>
							</tr>	   						   		
						</table>
					</td>
				</tr>
				...
				<table class="body">
					...
					<tr>
						...
						<td width="90%" rowspan="2">
							...
							<table width="100%">
							    <tr class="title">
									<td width="50%"><p style="color:#0D256E; font-size:25px; font-weight:bold;">Return Flight Information</p></td>
				...
				<table class="body">
					<tr>
						...
						<td width="90%" rowspan="2">
							<table width="100%">
								<tr class="title">
									<td width="50%"><p style="color:#0D256E; font-size:25px; font-weight:bold;">Return Drive Information</p></td>
									<td width="50%"><p style="width:100%; color:#fff; background-color:#fff; font-size:4px">e</p><p style="color:#F39F32; font-size:14px; text-align:right">Date:' . $trip->trip_location_datel . '</p></td>
								</tr>
        ...
        $flightportion .= '
			...
			<table class="body">
				<tr>
					...
					<td width="90%" rowspan="2">
						<p style="color:#0D256E; font-size:25px; font-weight:bold;">Flight portion</p>
						   <table width="100%">
							   <tr class="content-1">
        ...
        $carportion .= '
			...
			<table class="body">
				<tr>
					...
					<td width="90%" rowspan="2">
						<p style="color:#0D256E; font-size:25px; font-weight:bold;">Vehicle Portion</p>
						   <table width="100%">
							   <tr class="content-1">
        ...
        $trainportion .= '
			...
			<table class="body">
				<tr>
					...
					<td width="90%" rowspan="2">
						<p style="color:#0D256E; font-size:25px; font-weight:bold;">Train portion</p>
						   	<table width="100%">
							   	<tr class="content-1">
        ...
        if ($i != $len) { // list of end
            $html .= '
				<table cellspacing="0" cellpadding="0">
					<tr>
						<td width="10%">
							<span>&nbsp;</span><img src="./images/note_number/' . $i . '.png" style="width:30px; height:30px;" >
						</td>
...
if ($trip->trip_option_weather) {
    ...
    if ($weatherData[1]["Code"] == "Unauthorized") {
        ...
        $pdf->writeHTML(round((float) explode('&', $headerWeatherInfo[1])[0], 0) . "째C", true, false, true, false, '');
        $pdf->SetFont($fontname, '', 14, '', false);
        $pdf->SetTextColor(103, 117, 141);
        $pdf->SetXY(148, 68);
        ...
        if (strstr($document->name, '.pdf')) {
            ...
            try {
                ...
                for ($i = 0; $i < $pagecount; $i++) {
                    ...
                    $pdf->SetMargins(10, 12, 10);
                    // $pdf->Image($top_bar_image, 0, 0, 0, 0, '', '', '', false, 300, '', false, false, 0);
                    // $section_2 = new top_bar('Flight Itinerary', 'The travel plan of tomorrow done right today', $str_name);
                    // $html = $section_2->html_content();
                    // $pdf->writeHTML($html, true, false, true, false, '');
                    $tplidx = $pdf->importPage($i + 1);
                    $pdf->useTemplate($tplidx, 10, 28, 200);
                    // $pdf->Image($b_left, 3, 275, 23, 22, '', '', '', false, 300, '', false, false, 0);
                    // $pdf->Image($b_left_text, 28, 287, 50, 2.5, '', '', '', false, 300, '', false, false, 0);
                    // $pdf->Image($b_right, 174, 275, 37, 23, '', '', '', false, 300, '', false, false, 0);
                    // $pdf->SetXY(192, 285);
            ...
            $html = '<div style="text-align:center;">
				...
				<img src="./ajaxfiles/uploads/' . $document->name . '" width="600px" />
			</div>';
            // $pdf->Image($b_left, 3, 275, 23, 22, '', '', '', false, 300, '', false, false, 0);
            // $pdf->Image($b_left_text, 28, 287, 50, 2.5, '', '', '', false, 300, '', false, false, 0);
            // $pdf->Image($b_right, 174, 275, 37, 23, '', '', '', false, 300, '', false, false, 0);
        ...
        if (strstr($document->name, '.pdf')) {
            ...
            try {
                ...
                for ($i = 0; $i < $pagecount; $i++) {
                    ...
                    $pdf->SetMargins(10, 12, 10);
                    // $pdf->Image($top_bar_image, 0, 0, 0, 0, '', '', '', false, 300, '', false, false, 0);
                    // $section_2 = new top_bar('Hotel Itinerary', 'The travel plan of tomorrow done right today', $str_name);
                    // $html = $section_2->html_content();
                    // $pdf->writeHTML($html, true, false, true, false, '');
                    $tplidx = $pdf->importPage($i + 1);
                    $pdf->useTemplate($tplidx, 10, 28, 200);
        ...
        if (strstr($document->name, '.pdf')) {
            ...
            try {
                ...
                for ($i = 0; $i < $pagecount; $i++) {
                    ...
                    $pdf->SetMargins(10, 12, 10);
                    //$pdf->Image($top_bar_image, 0, 0, 0, 0, '', '', '', false, 300, '', false, false, 0);
                    //$section_2 = new top_bar('Addtional Documents', 'The travel plan of tomorrow done right today', $str_name);
                    //$html = $section_2->html_content();
                    //$pdf->writeHTML($html, true, false, true, false, '');
                    $tplidx = $pdf->importPage($i + 1);
                    $pdf->useTemplate($tplidx, 10, 28, 200);
        ...
        if (strstr($document->name, '.pdf')) {
            ...
            try {
                ...
                for ($i = 0; $i < $pagecount; $i++) {
                    ...
                    $pdf->SetMargins(10, 12, 10);
                    // $pdf->Image($top_bar_image, 0, 0, 0, 0, '', '', '', false, 300, '', false, false, 0);
                    // $section_2 = new top_bar('Passport Itinerary', 'The travel plan of tomorrow done right today', $str_name);
                    // $html = $section_2->html_content();
                    // $pdf->writeHTML($html, true, false, true, false, '');
                    $tplidx = $pdf->importPage($i + 1);
                    $pdf->useTemplate($tplidx, 10, 28, 200);
        ...
        if (strstr($document->name, '.pdf')) {
            ...
            try {
                ...
                for ($i = 0; $i < $pagecount; $i++) {
                    ...
                    $pdf->SetMargins(10, 12, 10);
                    // $pdf->Image($top_bar_image, 0, 0, 0, 0, '', '', '', false, 300, '', false, false, 0);
                    // $section_2 = new top_bar('Driver\'s License', 'The travel plan of tomorrow done right today', $str_name);
                    // $html = $section_2->html_content();
                    // $pdf->writeHTML($html, true, false, true, false, '');
                    $tplidx = $pdf->importPage($i + 1);
                    $pdf->useTemplate($tplidx, 10, 28, 200);
...
if ($trip->trip_option_directions) {
    if ($trip->trip_location_to_latlng != NULL || $trip->trip_location_to_latlng != '') {
        $origin_r1 = str_replace('(', '', $trip->trip_location_from_latlng);
        $origin_r1 = str_replace(')', '', $origin_r1);
        $destination_r1 = str_replace('(', '', $trip->trip_location_to_latlng);
...
if ($trip->trip_option_subway) {
    ...
    if (!$indir) {
        $destination_route_map = "https://maps.googleapis.com/maps/api/staticmap?center=" . urlencode($trip->trip_location_to) . "&style=feature:transit.line|element:all|visibility:simplified|color:0xFF6319&zoom=13&size=740x920&scale=2&key=$key";
        $html .= '
			<br><br><br><br>
			<img src="' . $destination_route_map . '" width ="740px" height="920px" />
		';
...
if ($trip->trip_option_hotels) {
    ...
    echo 'hotel';
    echo "<br>";
    $filterResult = $trip->getMapFilters($destination, 'hotel', $key);
