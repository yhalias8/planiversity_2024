...
(function ($) {
    if ($.fn.ajaxForm == undefined) {
        $.getScript(SITE + "js/upload/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        this.createProgress = function (filename, filepath, filesize) {
            ...
            var pd = new createProgressDiv(this, s, filename);
            pd.progressDiv.show();
            ...
            //pd.select.find('input[type=hidden]:first').click(changeDocOrientaion(fileNameStr));
            obj.fileCounter++;
            obj.selectedFiles++;
            if (s.showPreview) {
        ...
        function defaultProgressBar(obj, s, flname) {

            this.statusbar = $("<div class='ajax-file-upload-statusbar'></div>").width(s.statusBarWidth);
            this.preview = $("<img class='ajax-file-upload-preview' />").width(s.previewWidth).height(s.previewHeight).appendTo(this.statusbar).hide();
            this.filename = $("<div class='ajax-file-upload-filename'></div>").appendTo(this.statusbar);
            this.del = $("<div>" + s.deleteStr + "</div>").appendTo(this.statusbar).hide();
            this.select = $('<div class="dropdown" style="float: right;margin: 0;padding: 0;margin-top: -15px;padding-right: 25px;"><button type="button" class="btn dropdown-toggle format-dropdown" data-toggle="dropdown">Select Orientation</button><div class="dropdown-menu orientation"><a class="dropdown-item" onclick="changeDocOrientaion(\'L\', \'' + flname + '\')" href="#">Landscape</a><a onclick="changeDocOrientaion(\'P\', \'' + flname + '\')" class="dropdown-item" href="#">Portrait</a></div></div>').appendTo(this.statusbar);
            // this.del = $("<div>" + s.deleteStr + "</div>").appendTo(this.statusbar).hide();
        ...
        function createProgressDiv(obj, s, fl) {
            var bar = null;
            if (s.customProgressBar)
                bar = new s.customProgressBar(obj, s);
            else
                bar = new defaultProgressBar(obj, s, fl);
