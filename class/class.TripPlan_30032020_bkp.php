...
//               echo $query;die('--');
            ...
            $stmt->bindValue(5, ($location_datel_deptime) ? date('H:m', strtotime($location_datel_deptime)) : '00:00', PDO::PARAM_STR);
            $stmt->bindValue(6, ($location_datel_arrtime) ? date('H:m', strtotime($location_datel_arrtime)) : '00:00', PDO::PARAM_STR);
            ...
            $stmt->bindValue(10, ($location_dater_deptime) ? date('H:m', strtotime($location_dater_deptime)) : NULL, PDO::PARAM_STR);
            $stmt->bindValue(11, ($location_dater_arrtime) ? date('H:m', strtotime($location_dater_arrtime)) : NULL, PDO::PARAM_STR);
...
//                                            <tr>';
                for ($i = 0; $i <= 4; $i++) {
                    ...
                    $weather_data .='<td style="background-color:' . $bgColor . ';width: 20%;height:250px;" align="center">
                        <div style="padding: 10px;">
                            <h3 style="color: white;text-align: center;font-family:Montserrat-Medium" class="card-title">' . $from . '</h3>
                            <div style="text-align: center;margin-top: 50px;">
                                <img src="' . SITE . 'images/weather-icons/acc/' . $imgname . '" alt="">
                            </div>
                            <div style="margin-top: 50px;text-align: center;">
                                <h4 style="color: #f3a02e;font-family:Montserrat-Medium">' . $temp_max . '</h4>
                                <h4 style="color: white;font-family:Montserrat-Medium">' . $temp_min . '</h4>
                            </div>
                        </div>
                    </td>';
//                    if ($pdf) {
