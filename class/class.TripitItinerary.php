...
class TripitItinerary
{
    public $table;

    function __construct()
    {
        $this->table = 'tripit_itineraries';
    }

    function put_data($item)
    {
        global $dbh;
        $query = "INSERT INTO " . $this->table . " (user_id,trip_id,title,primary_location) VALUES (?,?,?,?)";
    ...
    function get_data_by_trip_id($tid)
    {
        global $dbh;
