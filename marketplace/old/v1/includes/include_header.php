            ...
            <div class="row">
                            ...
                            <form>
                                ...
                                <div class="inner-form">
                                    ...
                                    <div class="input-field fouth-wrap">
                                        ...
                                        <select data-trigger="" name="choices-single-defaul" class="form-control form_category">
                                            <option placeholder="">Choose Category</option>
                                            <option>One Option</option>
                                            <option>Two Option</option>
                                            <option>Four Option</option>
                                        </select>
                                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="banner-image">
                        ...
                        <img src="<?= SITE; ?>marketplace/images/intro-image.png" class="into-image">
                    </div>
