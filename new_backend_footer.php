    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-5 left-footer">
                <a href="#" class="footer-text-style">Privacy</a>
                <a href="#" class="footer-text-style pl-4">Terms of Services</a>
            </div>
            <div class="col-md-7">
                <p class="footer-text text-right">&copy; Copyright. 2015 - <?php echo date('Y'); ?> Planiversity, LLC. All Rights Reserved. </p>
            </div>
        </div>
    </div>
</footer>
