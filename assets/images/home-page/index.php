...
<head>
    ...
    <link href="<?= SITE; ?>home-page/css/home-style.css?v=20231610" rel="stylesheet">
    <link href="<?= SITE; ?>home-page/css/search.css?v=20231610" rel="stylesheet">
    <link href="<?= SITE; ?>home-page/css/custom.css?v=20231610" rel="stylesheet">
    <link href="<?= SITE; ?>home-page/css/home-responsive.css?v=20231610" rel="stylesheet">
    ...
    <script>
        ...
        var FILE_PATH = 'https://admin.planiversity.com/public/storage/uploads/';
    </script>
...
<body>
  ...
  <!-- End Google Tag Manager (noscript) -->
                ...
                <div class="header1 po-relative">
                    <div class="container p-0">
                        <nav class="navbar navbar-expand-lg h1-nav">
                            ...
                            <img src="<?= SITE; ?>assets/images/home-page/logo.png">
                            </a>
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                        ...
                        <div class="create_your_toute_left_text mockup_section">
                            <h2 class="common_heading">Plan, Execute, Communicate <span> Elevate every travel or</span> event experience</h2>
                            ...
                            <div class="top-action">
                                <a href="https://www.planiversity.com/registration" class="action_button">
                                    Start Planning Now
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 oorder_2">
                        <div class="trip-mockup"> <img src="<?= SITE; ?>assets/images/home-page/top_mobile_image.png"> </div>
                    </div>
                </div>
            </div>
    ...
    <section class="create_a_schedule_sec container-800">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 oorder_2">
                    <img class="mobile_landing_app_img" src="<?= SITE; ?>assets/images/home-page/mobile_landing_app.svg">
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-7 col-md-6 col-sm-6 padding_left">
                    <div class="create_your_toute_right_map"> <img class="toite-img" src="<?= SITE; ?>assets/images/home-page/filters_landing-min.svg"> </div>
                </div>
    ...
    <section class="add_resource_filters_sec container-800">
        <div class="container my-5">
            ...
            <div class="col-xl-7 col-lg-7 col-md-6 col-sm-6 padding_left">
                    <div class="create_your_toute_right_map"> <img class="mb-4" src="<?= SITE; ?>assets/images/home-page/app_landing.png"> </div>
                </div>

                <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6 d-flex align-items-center">
                    <div>
                        <img class="devices-icon" src="<?= SITE; ?>assets/images/home-page/devices-icon.png">
