                                    ...
                                    <div class="col-lg-6">
                                        <div class="mgn-top">
                                            <div class="radio form-check-inline">
                                                ...
                                                <label for="radio-case-by-case"> <p class = "billing-option-txt">Case By Case</p><span class = "billing-amount-txt">Only $1.29 per plan</span></label>
                                            </div>
                                        </div> 
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mgn-top">
                                            <div class="radio form-check-inline mgn-top-20">
                                                ...
                                                <label for="radio-monthly"> <p class = "billing-option-txt">Monthly Plan</p><span class = "billing-amount-txt">Unlimited uses per month for $9.99</span></label>
                                            </div>
                                        </div>   
                                    </div>
                                </div>
