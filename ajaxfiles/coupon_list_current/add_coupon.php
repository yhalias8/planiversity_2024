...
if (isset($_POST['title']) && isset($_POST['start_date']) && isset($_POST['coupon_code']) && isset($_POST['end_date']) && isset($_POST['percent']) && isset($_POST['status']) && isset($_POST['stripe_individual_plan_id']) && isset($_POST['stripe_business_plan_id']) && isset($_POST['paypal_individual_plan_id']) && isset($_POST['paypal_business_plan_id'])) {
    ...
    $query = "INSERT INTO coupon (title, coupon_code, percent,start_date,end_date,status,stripe_individual_plan_id,stripe_business_plan_id,paypal_individual_plan_id,paypal_business_plan_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
