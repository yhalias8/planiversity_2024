...
if (isset($_POST['code']) && isset($_POST['check']) && isset($_POST['date'])) {

    $code = filter_var($_POST["code"], FILTER_SANITIZE_STRING);

    $stmt = $dbh->prepare("SELECT sha1(id) as id,CURDATE() as today_date,coupon_code,start_date,end_date,percent FROM coupon WHERE coupon_code=? and status=?");
