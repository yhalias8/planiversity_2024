...
<head>
    ...
    <link href="<?= SITE; ?>assets/css/app-style.css" rel="stylesheet" type="text/css" />
...
<body>
            ...
            <div class="container-fluid">
                <div class="logo">
                    <a href="<?= SITE; ?>" class="logo">
                        <span class="logo-small"><img src="<?= SITE; ?>assets/images/logo-icon.png" alt="logo icon"></span>
                    ...
                    <ul class="list-inline float-right mb-0">
                        ...
                        <li class="list-inline-item dropdown more-nav-list new-backend-header-style">
                            <a class="nav-link dropdown-toggle arrow-none link-drop" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                <span><?= isset($userdata['name']) ? $userdata['name'] : "Test"; ?></span>
                            </a>
                        ...
                        <li class="list-inline-item dropdown more-nav-list new-backend-header-style">
                            ...
                            ?>
                            <img src="<?= SITE . $img; ?>" width="35px" height="35px" alt="user" class="header-avatar rounded-circle">
                        </li>
                        <!-- <?php if ($auth->isLogged()) { ?>
                    <li class="list-inline-item dropdown more-nav-list">
                        <a href="<?= SITE; ?>logout" class="dropdown-item drop-menu-item" style="font-size: 15.2px;">
                            <span>Logout</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown " aria-labelledby="Preview">
                            <div class="dropdown-item noti-title">
                                <h5 class="text-overflow">
                                    <small class="text-white"><?= $userdata['name']; ?></small>
                                </h5>
                            </div>
                            <a href="<?= SITE; ?>logout" class="dropdown-item drop-menu-item">
                                <span>Logout</span>
            ...
            <div class="container-fluid">
                <div id="navigation">
                    <ul class="navigation-menu header-top-bar-style">
                        <li>
                            <a href="<?= SITE; ?>welcome">Home</a>
                        </li>
                        <li class="active-link">
                            <a href="<?= SITE; ?>apanel/routes">Routes</a>
                        </li>
                        <li>
                            <a href="<?= SITE; ?>apanel/settings">Settings</a>
                        </li>
                        <li>
                            <a href="<?= SITE; ?>apanel/transactions">Transactions</a>
                        </li>
                        <li>
                            <a href="<?= SITE; ?>apanel/users">Users</a>
                        </li>
                        <li>
                        <a href="<?php echo SITE; ?>apanel/coupon">Coupon</a>
                        </li>                        
                        <li class="pull-right">
                            <a class="new-account-btn" data-toggle="modal" data-backdrop="false" data-target="#new-user-modal">Create New Account
    ...
    <section class="admin_subheader">
        <div class="admin_in">
            <p><a href="<?= SITE; ?>apanel/routes">Admin</a> / <strong>Routes</strong></p>
                        ...
                        <form name="admin_users" method="get" class="form-horizontal">
                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <h3>Search Filter&nbsp;<a class="right <?= $showclear; ?>" href="<?= SITE; ?>apanel/users">Clear</a></h3>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="admin-select-style">
                                                <select onChange="this.form.submit()" name="s_type" class="input-lg inp1">
                                                    <option <?= $contains; ?> value="contains">Contains</option>
                                                    <option <?= $equal; ?>>Equal to</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <input type="text" class="admin-form-control form-control input-lg" name="search_string" value="<?= $_GET['search_string']; ?>" title="write and press enter" required="">
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <div>
                                            <input class="admin-form-control form-control input-lg" onChange="this.form.submit()" name="created" id="created" type="text" value="<?= $_GET['created']; ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <input class="admin-form-control form-control input-lg" onChange="this.form.submit()" name="created2" id="created2" type="text" value="<?= $_GET['created2']; ?>" />
                                    </div>
                                </div>
                            </div>
                            </fieldset>
                            ...
                            <script src="<?= SITE; ?>js/node_modules/jquery.datetimepicker.js"></script>
                            <script>
                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            ...
                            <ul class="admin-user-dt">
                                <li>
                                    <p>Email: <span><?= $user_view_data[0]->email; ?></span></p>
                                </li>
                                <li>
                                    <p>Title: <span><?= $user_view_data[0]->title; ?></span></p>
                                </li>
                                <li>
                                    <p>Transport: <span><?= $user_view_data[0]->transport; ?></span></p>
                                </li>
                                <li>
                                    <p>Location From: <span><?= $user_view_data[0]->location_from; ?></span></p>
                                </li>
                                <li>
                                    <p>Location To: <span><?= $user_view_data[0]->location_to; ?></span></p>
                                </li>
                                <li>
                                    <p>Date Created:
                                        <span><?= date('M d,Y h:i a', strtotime($user_view_data[0]->date_created)); ?></span>
                                    </p>
                                </li>
                            </ul>
                        </div>
    ...
    <script src="<?= SITE; ?>assets/js/jquery.scrollTo.min.js"></script>
