...
if (isset($_POST['lat_to'])) {
    $lat_to = $_POST['lat_to'];
    $lng_to = $_POST['lng_to'];
    $showclear = 1;
} elseif (!empty($trip->trip_option_circle)) {
                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-md-12 col-lg-3">
                                    ...
                                    //echo 'long name: '.$locality_long_name;
                                    //echo 'country: '.$country_long_name;
                                    ...
                                    //echo $locality_long_name.', '.$political_long_name.'<br>';
                                    ?>


                                    <!--<div class="cont_blue_l">-->
                                    ...
                                    <input name="lat_to" id="lat_to" class="inp1" value="<?php echo $lat_to; ?>" type="hidden">
                                    <input name="lng_to" id="lng_to" class="inp1" value="<?php echo $lng_to; ?>" type="hidden">
                                    <input name="locality_long_name" id="locality_long_name" class="inp1" value="<?php echo $locality_long_name; ?>" type="hidden">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-8">
                                            ...
                                            <div class="filter-wrapper rounded p-0 background-main">
                                                <h6 class="modal-sub-title text-white"><img class="modal-sub-title-img" src="<?php echo SITE; ?>/images/flag_outline.png"></img>Facility Radius</h6>
                                                <div class="flexible-container rounded-bottom border-grey" id="filter_map"></div>
                                            </div>
                                            <!--<label for="radius">Scale:<input name="radius" id="radius" class="inp1" value="<?php echo $radius; ?>" type="text"><?PHP echo $scale; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Add a number value, then click the map to set location.</label>-->
                                            ...
                                            <div class="border-grey rounded">
                                                <div class="d-flex py-3 px-2 flex-row-reverse filter_button">
                                                    ...
                                                    <?php } ?>
                                                    <a href="<?php echo SITE; ?>trip/travel-documents/<?php echo $_GET['idtrip']; ?>" class="skip-note-btn mobile_skip">Skip This Section</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <!--<br clear="all" />-->
                                        <!--<input name="filter_submit" id="filter_submit" type="submit" class="button" value="SAVE AND NEXT">-->
                                        <?php //if($showclear) {  
                                        ?>
                                        <!--<input name="filter_clear" id="filter_clear" type="submit" class="button bt_blue" value="CLEAR FILTER">-->
                                        <?php //} 
                                        ?>
                                        <!--<br>-->
                                            ...
                                            <div class="background-main rounded h-100">
                                                ...
                                                <div class="direction-info-wrapper rounded border-grey filter-modal-left-content p-0">
                                                    <div class="">
                                                        ...
                                                        <p class="p-10px pt-0"><?PHP echo $text2; ?></p><br>
                                                    </div>
                                    ...
                                    <!--                                <div class="row">
                                                                        <div class="col-md-12 col-lg-10">
                                                                            <div class="form-group">
                                                                                <input name="filter_submit" id="filter_submit" type="submit"
                                                                                       class="create-trip-btn" value="Save and Next">
                                    <?php //if ($showclear) { 
                                    ?>
                                                                                            <input name="filter_clear" id="filter_clear" type="submit"
                                                                                                   class="refresh-btn" value="Clear Filter">
                                    <?php //} 
                                    ?>
                                                                                <button type="submit" class="create-trip-btn">Save and Next</button>
                                                                                <button type="submit" class="refresh-btn">Clear Filter</button>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12 col-lg-2">
                                                                            <a href="<?php //echo SITE;   
                                                                                        ?>trip/travel-documents/<?php // echo $_GET['idtrip'];   
                                                                                                                ?>"
                                                                               class="skip-note-btn">Skip This Section</a>
                                                                        </div>
                                                                    </div>-->

                                    <!--<a href="<?php echo SITE; ?>trip/travel-documents/<?php //echo $_GET['idtrip'];   
                                                                                            ?>" class="skip_notes">Skip Filters</a>-->
                                    <!--<br clear="all" />-->
    ...
    <script>
        ...
        function initMap() {
            ...
            if ($radius) {
                ...
                var circle = new google.maps.Circle({
                    ...
                    radius: <?php echo $radius; ?>, // 10 miles in metres
                    //fillColor: '#AA0000',
                    fillColor: "#FF0000",
                    strokeColor: "#FF0000",
                    strokeOpacity: 0.4,
            ...
            ?>
                bounds2.extend(new google.maps.LatLng(<?PHP echo $lat_to; ?>, <?PHP echo $lng_to; ?>));
                new DrawPlaneRoutes(map, <?PHP echo $lat_fromd; ?>, <?PHP echo $lng_fromd; ?>, <?PHP echo $lat_tod; ?>, <?PHP echo $lng_tod; ?>, <?php echo $location_multi_waypoint_latlng; ?>, 'portion');
            <?php }
            ...
            ?>
                ...
                new AutocompleteDirectionsHandler(map, 'driving', <?PHP echo $lat_fromd; ?>, <?PHP echo $lng_fromd; ?>, <?PHP echo $lat_tod; ?>, <?PHP echo $lng_tod; ?>, <?php echo $location_multi_waypoint_latlng; ?>, <?php echo $trip_via_waypoints ?>, true, "<?PHP echo $end_marker; ?>");
            ...
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(<?php echo $lat_tod ? $lat_tod : $lat_to; ?>, <?php echo $lng_tod ? $lng_tod : $lng_to; ?>),
                icon: 'https://planiversity.com/assets/images/icon.png',
                label: {
                    text: '<?php echo $end_marker; ?>',
                    color: "#ffffff",
                },
                map: map_filters,
                draggable: true,
        ...
        <?php if ($trip->trip_transport == 'vehicle' || $trip->trip_location_to_drivingportion) { ?>
            ...
            function show_directions(trMode) {
                ...
                bounds3.extend(new google.maps.LatLng(<?PHP echo $lat_from; ?>, <?PHP echo $lng_from; ?>));
                bounds3.extend(new google.maps.LatLng(<?PHP echo $lat_to; ?>, <?PHP echo $lng_to; ?>));
        ...
        <?php if ($trip_has_train) { ?>
            ...
            function show_directions_train() {
                ...
                bounds3t.extend(new google.maps.LatLng(<?PHP echo $lat_from; ?>, <?PHP echo $lng_from; ?>));
                bounds3t.extend(new google.maps.LatLng(<?PHP echo $lat_to; ?>, <?PHP echo $lng_to; ?>));
        ...
        <?php } ?>
        <?php if ($trip->trip_option_hotels) { ?>setTimeout(function() {
            NearbyPlacesHandler('lodging', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_police) { ?>setTimeout(function() {
            NearbyPlacesHandler('police', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_hospitals) { ?>setTimeout(function() {
            NearbyPlacesHandler('hospital', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_gas) { ?>setTimeout(function() {
            NearbyPlacesHandler('gas_station', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_embassis) { ?>setTimeout(function() {
            NearbyPlacesHandler('embassy', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_taxi) { ?>setTimeout(function() {
            NearbyPlacesHandler('taxi_stand', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_airfields) { ?>setTimeout(function() {
            NearbyPlacesHandler('airport', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_university) { ?>setTimeout(function() {
            NearbyPlacesHandler('university', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_atm) { ?>setTimeout(function() {
            NearbyPlacesHandler('atm', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_museum) { ?>setTimeout(function() {
            NearbyPlacesHandler('museum', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_church) { ?>setTimeout(function() {
            NearbyPlacesHandler('church', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_metro) { ?>setTimeout(function() {
            NearbyPlacesHandler('train_station', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_subway_station) { ?>setTimeout(function() {
            NearbyPlacesHandler('subway_station', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_playground) { ?>setTimeout(function() {
            NearbyPlacesHandler('park', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_library) { ?>setTimeout(function() {
            NearbyPlacesHandler('library', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_pharmacy) { ?>setTimeout(function() {
            NearbyPlacesHandler('pharmacy', 1);
        }, 1000);
        <?php } ?>
        <?php if ($trip->trip_option_covid) { ?>setTimeout(function() {
        ...
        <?php if ($trip->trip_option_directions) { ?>
            ...
            setTimeout(function() {
                ...
                $('#right-panel').show();
                show_directions();
                //$('#filter_directions').click();
                //$('#filter_directions').prop("checked", true);
            }, 1000);
        ...
        function NearbyPlacesHandler(filter, status) {
            ...
            if (!status) { // erase all markers
                ...
                var myLocation = {
                    lat: <?php echo $lat_tod ? $lat_tod : $lat_to; ?>,
                    lng: <?php echo $lng_tod ? $lng_tod : $lng_to; ?>
                };
        ...
        function createMarker(place) {
            ...
            if (document.getElementById('filter_atm').checked && !document.getElementById('filter_gas').checked && place.types['0'] == 'gas_station')
                place_icon = "<?php echo SITE; ?>images/map-icons/atm.png";
            ...
            if (document.getElementById('filter_church').checked && !document.getElementById('filter_university').checked && place.types['0'] == 'university')
                place_icon = "<?php echo SITE; ?>images/map-icons/church.png";
        ...
        function calculateAndDisplayRoute(directionsService, directionsDisplay, map, trmode) {
            ...
            <?php if ($trip->trip_location_from_drivingportion && $trip->trip_location_to_drivingportion) { ?>
                var start = document.getElementById('<?PHP echo $vehicle_location_from; ?>').value;
                var end = document.getElementById('<?PHP echo $vehicle_location_to; ?>').value;
