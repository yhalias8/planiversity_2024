...
<link href="<?php echo SITE; ?>style/style.css?v=20230209" rel="stylesheet" type="text/css" />
<link href="<?php echo SITE; ?>assets/css/app-style.css?v=202032" rel="stylesheet" type="text/css"/>
...
<script src="<?php echo SITE; ?>js/responsive-nav.js"></script>-->
        ...
        <script src="<?php echo SITE; ?>js/global.js?v=202030"></script>
        <?php include('new_head_files.php'); ?>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.3/jquery.validate.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.3/additional-methods.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
    <script src="https://localhost/master/stag/js/sweetalert.min.js"></script>        
        <style>
            /*    .modaltrans{
                    height: 66px;
                    width: 292px;
...
<?php include('new_backend_header.php'); ?>
    ...
    <div id="export-modal" data-backdrop="false" class="modal fade bs-example-modal-lg custom_prefix_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display:none">
        <div class="modal-dialog modal-custom-dialo modal-lg mt-xs-0 pt-xs-0 mt-sm-0 mt-md-0 mt-lg-3">
            <div class="modal-content connect-bg">
                ...
                <div class="modal-body connect-bg-ground" id="export-modal-body">
                    <form id="profile_form" class="routemap">
                        ...
                        <p class="event-title pb-0">Employee Profile </p>  
                        <fieldset>
                            <div class="row">
                                <div class="col-md-6">
                                            ...
                                            <select autofocus name="profile_employee" id="profile_employee" class="dashboard-form-control input-lg">
                                                ...
                                                if ($tmp && $stmt->rowCount() > 0) {
                                                    ...
                                                    foreach ($employees as $employee) {
                                                        $aux .= '<option value="' . $employee->id_employee . '"  >'
        ...
        function getPeopleList() {
            ...
            $.getJSON(SITE + "ajaxfiles/connect/list_processing.php", {
                ...
                $.each(data, function(index, item) {
                    ...
                    <h4>${name}</h4><p>${item.email}</p></div></div>
