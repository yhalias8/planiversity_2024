...
<body>
    ...
    <div id="proceed-to-pdf-modal" data-backdrop="false" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
        <form name="name_form" method="post" class="routemap">
                        ...
                        <fieldset>
                            ...
                            <div class="d-flex flex-row flex-wrap pt-4">
                                <div class="form-group mr-3">
                                    <!-- <button type="button" class="review-edit-export-btn cancel-finished" style="color: #0d2972; font-weight: bold" data-toggle="modal" data-target="#proceed-modal">Proceed</button> -->
            ...
            <div class="modal-content custom-modal-content">
                ...
                <div class="modal-body" style="padding-right: 20%;">
                    ...
                    <div class="all-doc-wrap slimscroll-itineraries" style="min-width: 540px">
                        ...
                        ?>
                                <div class="doc-item-wrapper" id="doc-<?php echo $document->id_document; ?>">
                                    <div class="col-md-1">
                                        <i class="fa fa-map-marker"></i>
                                    </div>
                                    <div class="col-md-7">
                                        <p class="p-mg-b p-mg-b-color"><?php echo $document->name; ?></p>
                                        <hidden type="hidden" value="<?php echo $document->name; ?>" />
                                    </div>
                                    <div class="col-md-3">
                                        <p class="p-mg-b">Destination</p>
                                    </div>
                                    <div class="col-md-1 text-right">
                                        <button onclick="remDoc(<?php echo $document->id_document; ?>)" class="remove-item-btn"><i class="fa fa-times-circle"></i></button>
                                    </div>
                                </div>
                        ...
                        ?>
                                <div class="doc-item-wrapper" id="tm-<?php echo $timeline->id_timeline; ?>">
                                    <div class="col-md-1">
                                        <i class="fa fa-map-marker"></i>
                                    </div>
                                    <div class="col-md-7">
                                        <p class="p-mg-b p-mg-b-color">Reminder - (<?php echo $timeline->title ?>) (<?php echo date('d F Y h:i a', strtotime($timeline->date)) ?>)</p>
                                    </div>
                                    <div class="col-md-3">
                                        <p class="p-mg-b">Destination</p>
                                    </div>
                                    <div class="col-md-1 text-right">
                                        <button onclick="remDel(<?php echo $timeline->id_timeline; ?>)" class="remove-item-btn"><i class="fa fa-times-circle"></i></button>
                                    </div>
                                </div>
                        <?php
                            }
                        ...
                        ?>
                                ...
                                <div class="doc-item-wrapper" id="nt-<?php echo $note->id_note; ?>">
                                    <div class="col-md-1">
                                        <i class="fa fa-map-marker"></i>
                                    </div>
                                    <div class="col-md-7">
                                        <p class="p-mg-b p-mg-b-color">Note - <?php echo $note->text; ?></p>
                                    </div>
                                    <div class="col-md-3">
                                        <p class="p-mg-b">Destination</p>
                                    </div>
                                    <div class="col-md-1 text-right">
                                        <button onclick="noteDel(<?php echo $note->id_note; ?>)" class="remove-item-btn"><i class="fa fa-times-circle"></i></button>
                                    </div>
                                </div>
                        <?php
                            }
                        ...
                        <!-- <div class="doc-item-wrapper">
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <p class="p-mg-b p-mg-b-color">This will not be the final view of your export. This will not be the final view of your export.</p>
                                </div>
                                <div class="col-md-3">
                                    <p class="p-mg-b">Destination</p>
                                </div>
                                <div class="col-md-1 text-center">
                                    <button class="remove-item-btn"><i class="fa fa-trash"></i></button>
                                </div>
                            </div>
                        </div> -->
                    </div>
                    <div class="d-flex justify-content-between">
                        ...
                        <button onclick="frmSubmit()" type="submit" class="create-trip-btn finished-export">Finished, proceed to export</button>
                    </div>
                </div>
                <div class="modal-footer">
