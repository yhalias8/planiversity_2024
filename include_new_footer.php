  ...
  <div class="container">
    <div class="row footer-border-bottom">
      ...
      <div class="col-md-3">
        ...
        <div class="footer-content-body">
          <a class="footer-sitemap" href="<?= SITE ?>blog">Blog</a>
        </div>
        <div class="footer-content-body">
      ...
      <div class="col-md-3">
       ...
       <div class="col-md-3">
      <p class="footer-content-titile">Policies</p></a>
      <a href="https://getterms.io/view/98sYm/privacy/en-us"><p class="footer-content-text">Privacy Policy </p></a>
      <a href="https://getterms.io/view/98sYm/tos/en-us"><p class="footer-content-text">Terms of Service</p></a>
      <a href="https://getterms.io/view/98sYm/cookie/en-us"><p class="footer-content-text">Cookies</p></a>
      <a href="https://getterms.io/view/98sYm/aup/en-us"><p class="footer-section3-text pt-4">AUP</p></a>
      <a href="https://getterms.io/g/98sYm"></a><p class="footer-section3-text">HTML</p></a>
       </div>
    </div>
    <div class="row">
      <div class="col-md-12">
...
<!-- <div class = "footer-bottom">
            	<div class="container">
	            	 <div class="col-md-12">
	                    <p class="copyright text-center">&copy; Copyright. 2015 - <?php echo date('Y'); ?>. Planiversity, LLC. All Rights Reserved.</p>
	                </div>
                </div>
            </div> -->
</div>
